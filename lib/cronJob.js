      ...
      if (pnls[i].symbol === margins[j].symbol) {
        if (pnls[i].pnl > margins[j].margin * 1.8) {
          ...
          const buyit = {
            ...
            msg: `⚠️ แจ้งเตือน\nเหรียญ : ${
              pnls[i].symbol
            }\nขายออโต้ที่กำไร 180% : ${parseFloat(pnls[i].pnl).toFixed(2)} ⚠️
        `
          }
          await lineNotifyPost.postLineNotify(buyit)
          ...
          const buyit = {
            ...
            msg: `⚠️ แจ้งเตือน\nเหรียญ : ${
              pnls[i].symbol
            }\nได้กำไรมากกว่า 150% : ${parseFloat(pnls[i].pnl).toFixed(2)} ⚠️
        `
          }
          await lineNotifyPost.postLineNotify(buyit)
          ...
          const buyit = {
            ...
            msg: `⚠️ แจ้งเตือน\nเหรียญ : ${
              pnls[i].symbol
            }\nได้กำไรมากกว่า 100% : ${parseFloat(pnls[i].pnl).toFixed(2)} ⚠️
        `
          }
          await lineNotifyPost.postLineNotify(buyit)
