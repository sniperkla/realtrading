...
const checkStopLoss4Step = async () => {
  ...
  for (let i = 0; i < symbol.length; i++) {
    ...
    console.log('checkTakeprofitZone', checkTakeprofitZone)
    ...
    if (side === 'SELL') {
      if (getPrice <= checkTakeprofitZone.zone1) {
        ...
        stopPriceCal = checkTakeprofitZone.zone1
        ...
        stopPriceCal = checkTakeprofitZone.zone2
