...
const leverageCal = async (
  ...
  console.log('this is defalut leverage', defaultLeverage)
  console.log('this is defalut leverage', leverage)
  ...
  console.log("ur ehere nothing prob")
  ...
  if (openLongShort.openLongShort < budget) {
    ...
    if (side === 'BUY') {
      if (cal > stopPriceCal) {
        lpStart = cal
        marginStart = openLongShort.openLongShort
        qtyStart = maximumQty
        ...
        while (cal > stopPriceCal) {
          ...
          if (cal < stopPriceCal) {
            ...
            lpEnd = cal
            marginEnd = openLongShort.openLongShort
            qtyEnd = maximumQty
        ...
        while (cal < stopPriceCal) {
          ...
          if (cal > stopPriceCal) {
            ...
            cal2 = calLiquidlity(
              ...
              Position1BOTH,
              price,
              withOutMaxQty.openLongShort,
              side
            )
            lpEnd2 = cal2
            marginEnd2 = withOutMaxQty.openLongShort
            qtyEnd2 = maximumQty
