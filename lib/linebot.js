    ...
    const settingCommandList = [
      {
        ...
        example: 'toggle_setting_sell value:1000 // ทำงานอัตโนมัติ'
      },
      {
      ...
      {
        cmd: 'เปิดใช้งาน MaginBalnce ถึง xxx สั่งขายทั้งหมด',
        example: 'toggle_mbalane_setting_sell value:2500 // ทำงานอัตโนมัติ'
      },
      {
        cmd: 'ตั้งค่า เปิด - ปิด MaginBalnce ถึง xxx สั่งขายทั้งหมด',
        example:
