  ...
  try {
    ...
    if (replyedMsg === 'show' || replyedMsg === '0' || replyedMsg === 'mar') {
      ...
      if (replyedMsg === 'mar') {
        messagesx.push({
          type: 'text',
          text: `สรุป \n${`ระดับ 1 :${lvchecks.lv1.name} usd ${lvchecks.lv1.count} รายการ รอเปิด ${lvchecks.lv1.left} รายการ \nระดับ 2 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 3 :${lvchecks.lv3.name} usd ${lvchecks.lv3.count} รายการ\nระดับ 4 :${lvchecks.lv4.name} usd ${lvchecks.lv4.count} รายการ\nระดับ 5 :${lvchecks.lv5.name} usd ${lvchecks.lv5.count} รายการ\nระดับ 6 :${lvchecks.lv6.name} usd ${lvchecks.lv6.count} รายการ\nระดับ 7 :${lvchecks.lv7.name} usd ${lvchecks.lv7.count} รายการ\nระดับ 8 :${lvchecks.lv8.name} usd ${lvchecks.lv8.count} รายการ\nระดับ 9 :${lvchecks.lv9.name} usd ${lvchecks.lv9.count} รายการ\nระดับ 10 :${lvchecks.lv10.name} usd ${lvchecks.lv10.count} รายการ`}`
        })
      }
      messagesx.push({
        type: 'text',
