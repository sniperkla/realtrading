...
const sendReply = async (text, replyTokens, replyedMsg) => {
  ...
  try {
    ...
    if (replyedMsg === 'show' || replyedMsg === '0' || replyedMsg === 'mar') {
      ...
      messagesx.push({
        type: 'text',
        text: `สรุป \n${`ระดับ 1 :${lvchecks.lv1.name} usd ${lvchecks.lv1.count} รายการ \nระดับ 2 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 3 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 4 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 5 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 6 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 7 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 8 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 9 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ\nระดับ 10 :${lvchecks.lv2.name} usd ${lvchecks.lv2.count} รายการ`}`
      })
      messagesx.push({
        type: 'text',
