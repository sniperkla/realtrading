...
const closeAllMarket = async () => {
  ...
  for (let i = 0; i < checkLog.length; i++) {
    const data = await Log.findOne({ symbol: symbol[i] })
...
const mainCalLeverage = async (body, margin) => {
  ...
  console.log('fuckingbotbody', body)

  console.log('fuckingbot1')
  console.log('fuckingbotsym', body.symbol)

  console.log('fuckingbot2', checkStoreSL)
